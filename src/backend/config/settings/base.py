...
# seconddx_web/
APPS_DIR = BASE_DIR / "seconddx_web"
env = environ.Env()
...
DATABASES = {
    ...
    "test": {
        "ENGINE": "django.db.backends.postgresql",
        "NAME": "test_seconddx_web",
        "USER": env("POSTGRES_USER", default="seconddx"),
...
MIGRATION_MODULES = {"sites": "seconddx_web.contrib.sites.migrations"}
...
LOGIN_REDIRECT_URL = "user-profile-general"
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "seconddx_web.users.context_processors.allauth_settings",
            ],
        },
    },
]
...
# https://docs.allauth.org/en/latest/account/configuration.html
ACCOUNT_ADAPTER = "seconddx_web.users.adapters.AccountAdapter"
# https://docs.allauth.org/en/latest/account/forms.html
ACCOUNT_FORMS = {"signup": "seconddx_web.users.forms.UserSignupForm"}
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_ADAPTER = "seconddx_web.users.adapters.SocialAccountAdapter"
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_FORMS = {"signup": "seconddx_web.users.forms.UserSocialSignupForm"}
# django-compressor
# -----------------------------------------------------------------------------
...
SPECTACULAR_SETTINGS = {
    "TITLE": "SecondDX API",
    "DESCRIPTION": "Documentation of API endpoints of SecondDX",
    "VERSION": "1.0.0",
